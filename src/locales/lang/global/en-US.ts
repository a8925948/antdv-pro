export default {
  ...
  'menu.oa-approval': 'OA Office Approval',
  'menu.oa-approval.dashboard': 'Finance Dashboard',
  'menu.oa-approval.center': 'Approval Center',
  'menu.oa-approval.receivable-payable': 'Receivables & Payables',
  'menu.oa-approval.cash': 'Cash Management',
  'menu.oa-approval.salary': 'Salary Management',
  'menu.oa-approval.org': 'Organization',
  'menu.oa-approval.vehicle': 'Office Vehicle',
  'menu.oa-approval.todo': 'My Pending Approvals',
  'menu.oa-approval.done': 'Approved Tasks',
  'menu.oa-approval.submitted': 'My Submissions',
  'menu.oa-approval.cc': 'Copied To Me',
  'menu.oa-approval.templates': 'Approval Templates',
  'menu.oa-approval.business': 'Business Writeback',
  'menu.transport': 'Transport Management',
  'menu.transport.operations': 'Operation Data',
  'menu.transport.orders': 'Transport Orders',
  'menu.transport.tracking': 'BeiDou GPS Monitoring',
  'menu.transport.fuel': 'Fuel Details',
  'menu.transport.etc': 'ETC Fees',
  'menu.transport.fees': 'Regulatory Fees',
  'menu.transport.maintenance': 'Maintenance',
  'menu.transport.driver-payroll': 'Driver Payroll',
  ...
  'menu.finance.settlement': 'Settlement Management',
  'menu.finance.invoices': 'Invoice Management',
  ...
  'menu.link': 'Resource Center',
  'menu.link.iframe': 'Company Site',
  'menu.link.antdv': 'Data Platform',
  'menu.link.external': 'Help Center',
  'menu.menu': 'Menu',
