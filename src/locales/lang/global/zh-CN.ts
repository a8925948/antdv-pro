export default {
  ...
  'menu.oa-approval': 'OA办公审批',
  'menu.oa-approval.dashboard': '财务看板',
  'menu.oa-approval.center': '审批中心',
  'menu.oa-approval.receivable-payable': '应收应付',
  'menu.oa-approval.cash': '现金管理',
  'menu.oa-approval.salary': '工资管理',
  'menu.oa-approval.org': '组织架构',
  'menu.oa-approval.vehicle': '办公用车',
  'menu.oa-approval.todo': '待我审批',
  'menu.oa-approval.done': '已办审批',
  'menu.oa-approval.submitted': '我发起的',
  'menu.oa-approval.cc': '抄送我的',
  'menu.oa-approval.templates': '审批模板',
  'menu.oa-approval.business': '业务回写',
  'menu.transport': '运输管理',
  'menu.transport.operations': '运营数据',
  'menu.transport.orders': '运输订单',
  'menu.transport.tracking': '北斗监控',
  'menu.transport.fuel': '加油明细',
  'menu.transport.etc': 'ETC费用',
  'menu.transport.fees': '规费管理',
  'menu.transport.maintenance': '维保管理',
  'menu.transport.driver-payroll': '司机薪酬',
  ...
  'menu.finance.invoices': '发票管理',
  'menu.finance.reports': '财务报表',
  ...
  'menu.link': '资源中心',
  'menu.link.iframe': '企业官网',
  'menu.link.antdv': '数据平台',
  'menu.link.external': '帮助中心',
  'menu.menu': '菜单',
  'menu.menu.menu1': '菜单1',
  'menu.menu.menu2': '菜单2',
