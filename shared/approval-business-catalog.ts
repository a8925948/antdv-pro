...
export const APPROVAL_BUSINESS_CATALOG: ApprovalBusinessCatalogItem[] = [
  ...
  { category: '人事薪酬类', label: '组织人事变更', businessType: 'hr_change', moduleName: '组织架构', modulePath: '/oa-approval/org', requireAttachment: true, defaultApproverIds: [4, 5], descriptionPlaceholder: '填写入转调离、部门岗位或人员信息变更事项', initiationSource: 'WECOM' },
